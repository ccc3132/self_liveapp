...
public class cms_reply_vo {
	...
	public int getCms_rno() {
		return cms_rno;
	}

	public void setCms_rno(int cms_rno) {
		this.cms_rno = cms_rno;
	}
	...
	public cms_reply_vo(int cms_bno, int cms_rno, String cms_title, String cms_content, String cms_writer,
			Date cms_regdate) {
		super();
		this.cms_bno = cms_bno;
		this.cms_rno = cms_rno;
	...
	public String toString() {
		return "cms_reply_vo [cms_bno=" + cms_bno + ", cms_rno=" + cms_rno + ", cms_title=" + cms_title
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		cms_reply_vo other = (cms_reply_vo) obj;
