	...
	<form id="memberdelete_form" name="memberdelete_form">
		<table>
			...
			<tr>
				<td>이름</td>
				<td>
					<input class="chk" type="text" id="mms_username" name="mms_username" value="${member.mms_username }" readonly="readonly" title="이름을 입력해주세요."/>
				</td>
			</tr>
		</table>
	</form>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var form_obj = $("form[name='memberdelete_form']");
		...
		$("#memberdelete_btn").on("click", function(){
			...
			$.ajax({
				...
				, type : "POST"
				, dataType : "json"
				, data : $("#memberdelete_form").serializeArray()
				, success : function(data) {
					if(data == true) {
						if(confirm("회원탈퇴 하시겠습니까?")) {
							form_obj.attr("action", "/dms_member/dms_0010_memberdelete");
	...
	function fn_valiChk() {
		...
		var reg_form = $("form[name='memberdelete_form'] .chk").length;
